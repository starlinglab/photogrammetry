import { Scene, PerspectiveCamera, WebGLRenderer, sRGBEncoding, Color, MeshBasicMaterial, AmbientLight } from 'three'
...
Promise.all([loader.loadAsync('./assets/artwall2.glb'), loader.loadAsync('./assets/artwall-cam2.glb')])
.then( assets => {
